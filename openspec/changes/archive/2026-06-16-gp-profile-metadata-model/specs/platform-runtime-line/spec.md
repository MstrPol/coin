...
### Requirement: Resolve injects platform runtime

**Reason**: Agent moved to GP draft composition; platform runtime is lib-only.

**Migration**: Update `platform_settings.runtime` schema and resolve merge logic (§9 tasks).
