...
**Reason**: Direct stable publish removed; releases only via draft promote.

**Migration**: Use «New draft» then promote on release detail. Legacy `/gp/:name/releases/new` redirects to `new-draft`.
