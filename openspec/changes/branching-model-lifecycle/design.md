...
|---|--------|--------|----------|
| Q1 | Применить Nexus gate ко всем Studio types сразу или только branching-model? | ⏳ | A: branching-model only (recommended) / B: all types |
| Q2 | Удалять PG bodies после promote? | ⏳ | A: keep for admin preview / B: delete (Nexus-only) |
