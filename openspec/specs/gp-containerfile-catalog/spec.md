# gp-containerfile-catalog Specification

## Purpose

Top-level `containerfiles[]` catalog for schemaVersion 4: managed/project entries referenced by pipeline steps by id; content on disk under `path`.
