# docs-monorepo-layout Specification

## Purpose

Canonical documentation of the integration workspace layout: sibling component repositories, the `coin/` meta repository, local pilot tooling, and corp prod repo split.
