...
import PlatformProfileCatalogPage, {
  buildProfileRows,
} from "./platform/PlatformProfileCatalogPage";

export default function BranchingModelsPage() {
  const family = PLATFORM_FAMILIES["branching-models"];
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        const profiles = all.items.filter((c: Component) => c.type === "branching-model");
